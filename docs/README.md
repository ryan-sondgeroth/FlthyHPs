...
This README is based on the manual in [`Guide to Using Your FlthyHPs v1.8 .docx`](Guide%20to%20Using%20Your%20FlthyHPs%20v1.8%20.docx), with updates aligned to the current `v2.1` sketch.
